...
// Fungsi untuk membuat/update tabel barang_di_gudang
function createTableBarangGudang($koneksi) {
    $query = "CREATE TABLE IF NOT EXISTS barang_di_gudang (
...
createTableBarangGudang($koneksi);
...
// ==================== FUNGSI KHUSUS BARANG DI GUDANG ====================

// Fungsi untuk mendapatkan nomor urut berikutnya
function getNextNoUrut($koneksi) {
    $query = "SELECT MAX(no_urut) as max_urut FROM barang_di_gudang";
    $result = mysqli_query($koneksi, $query);
...
// Fungsi untuk mendapatkan data barang di gudang
function getBarangDiGudang($koneksi) {
    $query = "SELECT * FROM barang_di_gudang ORDER BY no_urut ASC";
    $result = mysqli_query($koneksi, $query);
...
// Fungsi untuk menyimpan data barang di gudang
function saveBarangDiGudang($koneksi, $data, $foto = null) {
    // Escape semua input
    ...
    if (!empty($id)) {
        // UPDATE data
        $query = "UPDATE barang_di_gudang SET 
            no_urut = '$no_urut',
            nama_barang = '$nama_barang',
            ruangan = '$ruangan',
            merek = '$merek',
        ...
        // INSERT data baru
        $query = "INSERT INTO barang_di_gudang 
...
function deleteBarangDiGudang($koneksi, $id) {
    // Hapus file foto jika ada
    $data = getBarangDiGudangById($koneksi, $id);
    ...
    $id = mysqli_real_escape_string($koneksi, $id);
    $query = "DELETE FROM barang_di_gudang WHERE id = $id";
    return mysqli_query($koneksi, $query);
}

// Fungsi untuk mendapatkan data by ID
function getBarangDiGudangById($koneksi, $id) {
    return getDataByIdUniversal($koneksi, $id, 'di_gudang');
}

// Fungsi untuk mendapatkan statistik
function getStatistikBarangGudang($koneksi) {
    $statistik = [
        'total' => 0,
        'baik' => 0,
        'rusak_ringan' => 0,
    ...
    try {
        $query_total = "SELECT COUNT(*) as total FROM barang_di_gudang";
...
if (isset($_GET['hapus'])) {
    $id = $_GET['hapus'];
    if (is_numeric($id)) {
        if (deleteBarangDiGudang($koneksi, $id)) {
...
$data_barang_gudang = getBarangDiGudang($koneksi);
$statistik = getStatistikBarangGudang($koneksi);

// Cek apakah sedang edit atau lihat detail
$edit_data = null;
if (isset($_GET['edit']) && is_numeric($_GET['edit'])) {
    $edit_data = getDataByIdUniversal($koneksi, $_GET['edit'], 'di_gudang');
}

$detail_data = null;
if (isset($_GET['detail']) && is_numeric($_GET['detail'])) {
    $detail_data = getBarangDiGudangById($koneksi, $_GET['detail']);
}
...
<head>
    ...
    <title>Dashboard - Barang di Gudang</title>
        ...
        <main>
            <div class="head-title">
                <div class="left">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="#" class="active">Barang di Gudang</a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="table-data">
                <div class="order">
                    ...
                    <?php if (empty($data_barang_gudang)): ?>
                    <div class="no-data">
                        <i class="fas fa-inbox"></i>
                        <h3>Tidak ada data barang di gudang</h3>
                    ...
                    <div style="overflow-x: auto;">
                        <table>
                            ...
                            <tbody>
                                <?php foreach ($data_barang_gudang as $item): ?>
                                <tr>
                                    <td><?= $item['no_urut'] ?></td>
            ...
            <div class="form-container">
                ...
                <form method="POST" action="" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="status_barang" name="status_barang" required>
                            ...
                            <option value="di_gudang"
                                <?= (isset($edit_data['status_barang']) && $edit_data['status_barang'] == 'di_gudang') ? 'selected' : (isset($_GET['tambah']) ? 'selected' : '') ?>>
                    ...
                    <div class="form-group">
                        ...
                        <a href="di_gudang.php" class="btn-custom btn-secondary">
            ...
            <div class="container-detail">
                ...
                <a href="di_gudang.php" class="btn-back">
